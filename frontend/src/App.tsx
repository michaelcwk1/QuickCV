...
function CVBuilder() {
  ...
  // Load CV data dari localStorage
  useEffect(() => {
        ...
        <div className="min-h-screen bg-gradient-to-br from-violet-50 to-indigo-50">
          ...
          <Tabs defaultValue="edit" value={activeTab} onValueChange={setActiveTab} className="w-full h-full">
            <div className="p-4 border-b bg-white/90 backdrop-blur-md sticky top-0 z-10 shadow-sm">
              <h1 className="text-2xl font-bold text-center mb-4 text-transparent bg-clip-text bg-gradient-to-r from-violet-600 to-indigo-600">QuickCV</h1>
  ...
  return (
    <TooltipProvider>
      <ToasterProvider />
      <div className="min-h-screen bg-gradient-to-br to-indigo-100 animate-fade-in">
