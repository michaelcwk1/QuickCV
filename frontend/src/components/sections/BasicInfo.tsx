      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="Michael Christoper"
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="github.com/Michaelcwk1"
            className="transition-all duration-200 focus:ring-2 focus:ring-primary/10"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="linkedin.com/in/MichaelChristoper"
            className="transition-all duration-200 focus:ring-2 focus:ring-primary/10"
          />
        </div>
      </CardContent>
